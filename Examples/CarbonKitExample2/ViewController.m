...
- (nonnull UIViewController *)carbonTabSwipeNavigation:
    ...
    UIStoryboard *storyboard = [UIStoryboard storyboardWithName:@"Example1" bundle:nil];
    switch (index) {
    case 0:
        return [storyboard instantiateViewControllerWithIdentifier:@"ViewControllerOne"];

    case 1:
        return [storyboard instantiateViewControllerWithIdentifier:@"ViewControllerTwo"];

    default:
        return [storyboard instantiateViewControllerWithIdentifier:@"ViewControllerThree"];
    }
}
